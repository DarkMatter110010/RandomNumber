...
class Application:
    ...
    def create_widgets(self):
        ...
        self.numbutton.place(x=600,y=100, width=180, height=400)
        ...
        self.cleanbutton.place(x=600, y=520, width=180, height=60)
